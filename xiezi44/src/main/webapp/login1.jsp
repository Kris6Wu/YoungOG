...
<div id="main">
    ...
    <div class="container">
        ...
        <div class="register">
            ...
            <form action="login1.do" autocomplete="off">
            
                <div class="default">
                    <p>请输入用户名或手机号码</p>
                    <input id="uname" name="uname" data-form="required:true" type="text" placeholder="管理员账号"  autofocus required />
				...
				<img alt="无图片" src="http://localhost/xiezi44/vc1.do" height="40px"
						onclick="src='http://localhost/xiezi44/vc1.do?'+new Date();">
                <div class="submit">
                        <span class="notice">
